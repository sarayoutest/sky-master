...
>
  ...
  >
    ...
    >
      ...
      <Menu anchorEl={servicesAnchor}
       open={Boolean(servicesAnchor)} onClose={() => setServicesAnchor(null)} disableScrollLock PaperProps={{ sx: { mt: 2, borderRadius: "24px", minWidth: 550, p: 3, direction: isAr ? 'rtl' : 'ltr' } }}>
