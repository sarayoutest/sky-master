...
>
  <Grid item xs={12} md={6}>
    <Stack
      ...
      sx={{ pl: { xs: 1.5, md: 0 } ,
            ml:{xs :0 , md:-10}          }} 
    >
      <Typography sx={footerHover} fontSize={14}>Individuals Services</Typography>
      <Typography sx={footerHover} fontSize={14}>Paratrike Airtours</Typography>
      <Typography sx={footerHover} fontSize={14}>Paramotor Training</Typography>
    </Stack>
  </Grid>
  ...
  <Grid item xs={12} md={6}>
    ...
    ml:{xs :0 , md:18}  }}
    >
      <Typography sx={footerHover} fontSize={14}>Partnership with Us</Typography>
      <Typography sx={footerHover} fontSize={14}>Aerial Videography</Typography>
      <Typography sx={footerHover} fontSize={14}>Paramotor airshow</Typography>
    </Stack>
  </Grid>
</Grid>
...
>
  ...
  <Stack spacing={4} >
    ...
    <Stack direction="row" spacing={1} >
      ...
      <Typography sx={footerHover} variant="body2" fontSize="14px">
